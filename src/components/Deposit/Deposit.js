                    ...
                    <TableBody>
                        {
                            ...
                            (<TableRow key={index}>
                                    <TableCell sx={{minWidth:50,width:100,textAlign:'center','&.MuiTableCell-root':{padding:0}}}><Typography sx={style.tableDataText} >{item.transactionAmount}</Typography></TableCell>
                                    <TableCell sx={{minWidth:50,width:150, textAlign:'center','&.MuiTableCell-root':{padding:0}}}>
                                    <Typography sx={style.DateText} >{item.date.split('-')[0]}</Typography>
                                    <Typography sx={style.TimeText} >{item.date.split('-')[1]}</Typography>
                                    </TableCell>
                                    <TableCell sx={{minWidth:50,width:130, textAlign:'center','&.MuiTableCell-root':{padding:0}}}><Typography sx={style.tableDataText} >{item.utrNumber}</Typography></TableCell>
                                    <TableCell sx={{minWidth:50,width:130, textAlign:'center','&.MuiTableCell-root':{padding:0}}}><Typography sx={style.tableDataText} >{item.panel}</Typography></TableCell>
                                    ...
                                    <TableCell sx={{minWidth:100,width:1000, textAlign:'center','&.MuiTableCell-root':{padding:'10px 0px 10px 7px'}}}>
