...
const headCells=[
    ...
    {id:'frombank', label:'From Bank'},
    {id:'tobank', label:'To Bank'},
]
const recordsData=[
    createData('40,000',mergedTime(),5412,'Shivam-IDFC','Shivam-IDFC'),
    createData('30,000',mergedTime(),9412,'Shivam-Paytm','Shivam-Paytm'),
    ...
    createData('40,000',mergedTime(),5412,'Shivam-IDFC','Shivam-Paytm'),
    createData('30,000',mergedTime(),9412,'Shivam-Paytm','Shivam-IDFC'),
    createData('25,000',mergedTime(),7452,'Shivam-IDFC','Shivam-Paytm'),
    createData('20,000',mergedTime(),9574,'Shivam-Paytm','Shivam-IDFC'),
    createData('10,000',mergedTime(),6214,'Shivam-IDFC','Shivam-Paytm'),
]
...
const BankTransfer = () => {
  ...
  return (
    ...
    <Paper sx={{marginTop:'20px', borderRadius:'16px', paddingTop:3}}>
        ...
        <Typography sx={style.bankTransferText}>Bank Transfer</Typography>
